(function (e) {
    ...
    return function a(e, t, r) {
        ...
        1: [function (e, t, r) {
            ...
            t.exports = {render: o, renderToString: u, __parse: p, ParseError: a}
        }, {
            "./src/ParseError": 6,
            "./src/Settings": 8,
            "./src/buildTree": 13,
        ...
        7: [function (e, t, r) {
            ...
            h.prototype.handleUnsupportedCmd = function () {
                ...
                var a = new c("text", {body: t, type: "text"}, this.mode);
                var i = new c("color", {color: this.settings.errorColor, value: [a], type: "color"}, this.mode);
                this.consume();
                return i
            };
            h.prototype.parseAtom = function () {
                ...
                if (t || r) {
                    return new c("supsub", {base: e, sup: t, sub: r}, this.mode)
                } else {
                    return e
                }
            };
            ...
            h.prototype.parseImplicitGroup = function () {
                ...
                if (t === "\\left") {
                    ...
                    return new c("leftright", {body: r, left: a.value.value, right: n.value.value}, this.mode)
                } else if (t === "\\begin") {
                    ...
                    var m = {mode: this.mode, envName: o, parser: this, positions: h.pop()};
                    var f = u.handler(m, h);
                    ...
                    r = this.parseExpression(false);
                    return new c("sizing", {size: "size" + (l.indexOf(d, t) + 1), value: r}, this.mode)
                } else if (l.contains(g, t)) {
                    r = this.parseExpression(true);
                    return new c("styling", {style: t.slice(1, t.length - 5), value: r}, this.mode)
                } else {
            ...
            h.prototype.callFunction = function (e, t, r, i) {
                var n = {funcName: e, parser: this, positions: r, token: i};
        ...
        9: [function (e, t, r) {
            ...
            t.exports = {DISPLAY: y[o], TEXT: y[p], SCRIPT: y[c], SCRIPTSCRIPT: y[f]}
        }, {"./fontMetrics.js": 17}],
        10: [function (e, t, r) {
            var a = e("./domTree");
            var i = e("./fontMetrics");
        ...
        11: [function (e, t, r) {
            ...
            w.supsub = function (e, t) {
                ...
                if (!e.value.sup) {
                    ...
                    S = n.makeVList([{type: "elem", elem: s}], "shift", v, t);
                    ...
                    S = n.makeVList([{type: "elem", elem: a}], "shift", -f, t);
                    S.children[0].style.marginRight = k
                } else {
                    f = Math.max(f, y, u.depth + .25 * c.metrics.xHeight);
                    ...
                    S = n.makeVList([{type: "elem", elem: s, shift: v}, {
                        type: "elem",
                        elem: a,
                        shift: -f
            ...
            w.genfrac = function (e, t) {
                ...
                if (v === 0) {
                    ...
                    x = n.makeVList([{type: "elem", elem: f, shift: y}, {
                        type: "elem",
                        elem: c,
                        shift: -d
                    }], "individualShift", null, t)
                    ...
                    x = n.makeVList([{type: "elem", elem: f, shift: y}, {
                        ...
                        elem: S,
                        shift: M
                    }, {type: "elem", elem: c, shift: -d}], "individualShift", null, t)
                }
            ...
            w.array = function (e, t) {
                ...
                for (i = 0, D = 0; i < l || D < R.length; ++i, ++D) {
                    ...
                    for (r = 0; r < s; ++r) {
                        ...
                        G.depth = B.depth;
                        G.height = B.height;
                        L.push({type: "elem", elem: G, shift: V})
                    }
            ...
            w.op = function (e, t) {
                ...
                if (s) {
                    ...
                    if (!r) {
                        R = m.height - f;
                        q = n.makeVList([{type: "kern", size: o.metrics.bigOpSpacing5}, {
                            type: "elem",
                            elem: S
                        }, {type: "kern", size: M}, {type: "elem", elem: m}], "top", R, t);
                        q.children[0].style.marginLeft = -d + "em"
                    } else if (!a) {
                        E = m.depth + f;
                        q = n.makeVList([{type: "elem", elem: m}, {type: "kern", size: k}, {
                            type: "elem",
                            elem: w
                        }, {type: "kern", size: o.metrics.bigOpSpacing5}], "bottom", E, t);
                        ...
                        q = n.makeVList([{type: "kern", size: o.metrics.bigOpSpacing5}, {
                            type: "elem",
                            elem: S
                        }, {type: "kern", size: M}, {type: "elem", elem: m}, {type: "kern", size: k}, {
                            type: "elem",
                            elem: w
                        }, {type: "kern", size: o.metrics.bigOpSpacing5}], "bottom", E, t);
                        q.children[0].style.marginLeft = -d + "em";
            ...
            w.overline = function (e, t) {
                ...
                l.height = s;
                l.maxFontSize = 1;
                var u = n.makeVList([{type: "elem", elem: a}, {type: "kern", size: 3 * s}, {
                    type: "elem",
                    elem: l
            ...
            w.underline = function (e, t) {
                ...
                l.height = s;
                l.maxFontSize = 1;
                var u = n.makeVList([{type: "kern", size: s}, {type: "elem", elem: l}, {
                    type: "kern",
                    size: 3 * s
                }, {type: "elem", elem: a}], "top", a.height, t);
            ...
            w.sqrt = function (e, t) {
                ...
                if (a.height === 0 && a.depth === 0) {
                    ...
                    y = n.makeVList([{type: "elem", elem: a}, {type: "kern", size: c}, {
                        type: "elem",
                        elem: u
                    }, {type: "kern", size: l}], "firstBaseline", null, t)
                }
                if (!e.value.index) {
                    ...
                    var M = .6 * (k - S);
                    var T = n.makeVList([{type: "elem", elem: w}], "shift", -M, t);
                    var A = p(["root"], [T]);
            ...
            w.accent = function (e, t) {
                ...
                v = n.makeVList([{type: "elem", elem: l}, {type: "kern", size: -c}, {
                    type: "elem",
                    elem: v
        ...
        13: [function (e, t, r) {
            ...
            var p = function (e, t, r) {
                ...
                var p = new s({style: n, size: "size5"});
                var h = i(e, t, p);
                var c = a(e, p);
                var m = u(["katex"], [h, c]);
                if (r.displayMode) {
        ...
        14: [function (e, t, r) {
            ...
            var k = [{type: "small", style: i.SCRIPTSCRIPT}, {type: "small", style: i.SCRIPT}, {
                type: "small",
                style: i.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}];
            var z = [{type: "small", style: i.SCRIPTSCRIPT}, {type: "small", style: i.SCRIPT}, {
                type: "small",
                style: i.TEXT
            }, {type: "stack"}];
            var S = [{type: "small", style: i.SCRIPTSCRIPT}, {type: "small", style: i.SCRIPT}, {
                type: "small",
                style: i.TEXT
            ...
            t.exports = {sizedDelim: w, customSizedDelim: A, leftRightDelim: N}
        ...
        15: [function (e, t, r) {
            ...
            var o = {"\xee": "\u0131\u0302", "\xef": "\u0131\u0308", "\xed": "\u0131\u0301", "\xec": "\u0131\u0300"};
            ...
            t.exports = {span: s, documentFragment: l, symbolNode: u}
        ...
        16: [function (e, t, r) {
            ...
            o(["matrix", "pmatrix", "bmatrix", "Bmatrix", "vmatrix", "Vmatrix"], {}, function (e) {
                ...
                r = l(e.parser, r);
                if (t) {
                    r = new s("leftright", {body: [r], left: t[0], right: t[1]}, e.mode)
                }
                return r
            });
            o("cases", {}, function (e) {
                var t = {
                    type: "array",
                    arraystretch: 1.2,
                    cols: [{type: "align", align: "l", pregap: 0, postgap: n.TEXT.metrics.quad}, {
                        type: "align",
                        align: "l",
                        pregap: 0,
                        postgap: 0
                ...
                t = l(e.parser, t);
                t = new s("leftright", {body: [t], left: "\\{", right: "."}, e.mode);
                return t
            });
            o("aligned", {}, function (e) {
                ...
                for (var i = 0; i < a; ++i) {
                    ...
                    t.value.cols[i] = {type: "align", align: n, pregap: o, postgap: 0}
                }
                return t
            })
        ...
        17: [function (e, t, r) {
            ...
            t.exports = {metrics: w, sigmas: n, getCharacterMetrics: S}
        ...
        19: [function (e, t, r) {
            ...
            l("\\rule", {numArgs: 2, numOptionalArgs: 1, argTypes: ["size", "size", "size"]}, function (e, t) {
                var r = t[0];
                var a = t[1];
                var i = t[2];
            ...
            l(["\\mathord", "\\mathbin", "\\mathrel", "\\mathopen", "\\mathclose", "\\mathpunct", "\\mathinner"], {numArgs: 1}, function (e, t) {
                var r = t[0];
            ...
            l("\\stackrel", {numArgs: 2}, function (e, t) {
                ...
                var n = new s("supsub", {base: i, sup: r, sub: null}, r.mode);
                return {type: "mclass", mclass: "mrel", value: [n]}
            });
            ...
            var c = {"\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak"};
            ...
            l(["\\arcsin", "\\arccos", "\\arctan", "\\arg", "\\cos", "\\cosh", "\\cot", "\\coth", "\\csc", "\\deg", "\\dim", "\\exp", "\\hom", "\\ker", "\\lg", "\\ln", "\\log", "\\sec", "\\sin", "\\sinh", "\\tan", "\\tanh"], {numArgs: 0}, function (e) {
                return {type: "op", limits: false, symbol: false, body: e.funcName}
            });
            l(["\\det", "\\gcd", "\\inf", "\\lim", "\\liminf", "\\limsup", "\\max", "\\min", "\\Pr", "\\sup"], {numArgs: 0}, function (e) {
            ...
            l(["\\coprod", "\\bigvee", "\\bigwedge", "\\biguplus", "\\bigcap", "\\bigcup", "\\intop", "\\prod", "\\sum", "\\bigotimes", "\\bigoplus", "\\bigodot", "\\bigsqcup", "\\smallint"], {numArgs: 0}, function (e) {
            ...
            l(["\\dfrac", "\\frac", "\\tfrac", "\\dbinom", "\\binom", "\\tbinom", "\\\\atopfrac"], {
                ...
                return {type: "genfrac", numer: r, denom: a, hasBarLine: i, leftDelim: n, rightDelim: s, size: l}
            });
            ...
            l(["\\bigl", "\\Bigl", "\\biggl", "\\Biggl", "\\bigr", "\\Bigr", "\\biggr", "\\Biggr", "\\bigm", "\\Bigm", "\\biggm", "\\Biggm", "\\big", "\\Big", "\\bigg", "\\Bigg"], {numArgs: 1}, function (e, t) {
                var r = m(t[0], e);
                return {type: "delimsizing", size: p[e.funcName].size, mclass: p[e.funcName].mclass, value: r.value}
            });
            ...
            l(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot"], {numArgs: 1}, function (e, t) {
                var r = t[0];
        ...
        20: [function (e, t, r) {
            ...
            t.exports = {MathNode: i, TextNode: n}
        }, {"./utils": 25}],
        21: [function (e, t, r) {
        ...
        23: [function (e, t, r) {
            ...
            function a(e, r, a, i, n) {
                t.exports[e][n] = {font: r, group: a, replace: i}
            }
        ...
        25: [function (e, t, r) {
            ...
            t.exports = {contains: n, deflt: s, escape: c, hyphenate: o, indexOf: i, setTextContent: m, clearNode: v}
        }, {}]
    }, {}, [1])(1)
});
